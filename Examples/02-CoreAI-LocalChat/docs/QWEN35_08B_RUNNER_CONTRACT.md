...
Xcode checked: `/Users/rniranjan/Downloads/Xcode-beta.app`
...
2. Those APIs are not present in the installed Xcode 27 beta SDK
3. The lower-level `AIModel` load path exists, but this app still lacks a public Apple tokenizer/chat-template surface for prompt -> `input_ids`
